...
public class RatingDialog extends Dialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    private String defaultHint = "Suggest us what went wrong\n and we'll work on it.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        TelemetryHelper.logEvent("rating", "on_create");
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            TelemetryHelper.logEvent("rating_button_clicked", "dialog_rating_button_negative", "impossile");
            //do nothing
//            dismiss();
//            showNever();

        } else if (view.getId() == R.id.dialog_rating_button_positive) {
            TelemetryHelper.logEvent("rating_button_clicked", "dialog_rating_button_positive", "impossible");
            //do nothing
            //dismiss();
        } else if (view.getId() == R.id.dialog_rating_button_feedback_submit) {
            String feedback = etFeedback.getText().toString().trim();
            TelemetryHelper.logEvent("rating_button_clicked", "dialog_rating_button_feedback_submit");
            ...
            if (builder.ratingDialogFormListener != null) {
                TelemetryHelper.logEvent("rating_button_clicked", "feedback_submit", "impossible");
                builder.ratingDialogFormListener.onFormSubmitted(feedback);
            } else {
                TelemetryHelper.logEvent("rating_button_clicked", "email");
                sendEmail(feedback);
            }
            ...
            TelemetryHelper.logEvent("rating_button_clicked", "dismiss");
            dismiss();
        }
    }
    ...
    public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
        TelemetryHelper.logEvent("rating_button_clicked_onRatingChanged", "onRatingChanged", "rating:" + ratingBar.getRating());
    ...
    private void openPlaystore(Context context) {
        try {
            ...
            TelemetryHelper.logEvent("Exception", "open_playstore", e.getMessage());
        }
