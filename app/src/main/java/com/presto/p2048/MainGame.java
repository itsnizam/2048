...
public class MainGame {
    ...
    public void showLeaderBoard() {
        ...
        mView.showLeaderBoard();
    }

    public void showRateDialog() {
        final RatingDialog ratingDialog = new RatingDialog.Builder(ContextHolder.getMainActivity())
                .threshold(4)
                .session(7)
                .build();
